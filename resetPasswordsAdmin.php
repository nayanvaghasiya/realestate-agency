...
if (mysqli_num_rows($getEmailQuery) == 0) {
    exit('Session expires. Go to Login Page and <a href="login.php">Login</a> from here.');
}
$check = 1;
...
if (isset($_POST["password"])) {
    ...
    $q = mysqli_query($con, " UPDATE admin SET password = '$pass' WHERE email = '$email' ");
        ...
        <form method="POST">
            <div class="card border-secondary py-5">
                ...
                if ($check == 0) { ?>
                    <div class="row">
                        <div class="col px-5">
                            <h2>Password Updated Successfully. <a href="login.php">Login Now!</a></h2>
                        </div>
                    </div>
                <?php } ?>
            </div>
