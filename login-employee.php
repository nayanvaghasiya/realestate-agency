...
<head>
  ...
  <title>Real estate - employee panel</title>
</head>

<body>

  <form action="validation-employee.php" method="POST" class="px-xl-5 py-5">
  ...
  <a class="dropdown-item px-xl-5 py-3" href="requestReset.php">Forgot password?</a>
